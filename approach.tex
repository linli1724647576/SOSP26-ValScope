...
Set-level approximations can trigger value changes through monotone operators,
...
In the pre-processing phase, we randomly populate multiple tables in a test database, following standard DBMS random testing practices~\cite{kamm2023testing}. 
...
\begin{figure}[t]
	...
	\begin{array}{rlcl}
		...
		\textit{Const} & CONST & ::= &
		\text{integer, string, float, TRUE, FALSE, NULL}
	\end{array}
	\]
	\vspace{-3mm}
