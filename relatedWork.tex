...
Building on this foundation, our work extends the set semantics to the value semantics level, enabling the detection of subtler logical bugs that cannot be captured by set inclusion alone.  
